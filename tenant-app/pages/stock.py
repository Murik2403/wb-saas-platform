    ...
    with stock_tabs[5]:
        ...
        if incident_diag.empty:
            ...
            st.info(
                ...
                "а также ручные поступления WB Control. Продажи и возвраты учитываются по оперативному /supplier/sales. "
            ...
            if not v67_suspense.empty:
                ...
                st.warning(
                    ...
                    "Такой слой блокируется для автоматического COGS: при будущей продаже WB Control выдаст ошибку вместо synthetic-ставки."
                )
