...
def render(ctx: dict) -> None:
    ...
    if float(f.get("report_rows", 0) or 0) <= 0:
        ...
        if fifo_sales.empty:
            ...
            st.caption(
                "Операции, зафиксированные до перехода на послойный учёт FIFO, оцениваются по базовой себестоимости. "
        ...
        st.caption(
            "Расчёт учитывает полный горизонт пополнения: время до появления товара на WB плюс страховой запас. "
