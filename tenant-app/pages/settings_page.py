...
def render(ctx: dict) -> None:
    ...
    st.markdown("### 5.2. Послойная стоимость готовой продукции — FIFO")
    st.caption(
    ...
    st.markdown("### 5.3. FIFO-себестоимость продаж и возвратов")
    st.caption(
    ...
    st.info(
        ...
        "Если фактический остаток WB и слои расходятся из-за задержек API или внешних поставок, используйте сверку в разделе 5.2; сверочные списания не считаются продажами."
    )
    ...
    st.markdown("### 5.4. Контроль расхождений FIFO")
    st.caption(
    ...
    st.markdown("### 6. Готовая продукция и поставки на WB")
    st.caption(
    ...
    st.markdown("### 8. Резервные копии и восстановление")
    st.caption(
